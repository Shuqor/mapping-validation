...
from tests.test_stage9_json_bridge_baseline_snapshot import project_stage9_json_bridge_report


BASELINE_PATH = Path("results/stage9_json_bridge_baseline.json")
...
def main() -> None:
    ...
    payload = {
        "snapshot_name": "stage9_json_bridge_baseline",
        "generated_at_utc": datetime.now(timezone.utc).isoformat(),
        "inputs": {
            "spec_path": "rules/spec.xlsx",
            "input_payload_path": "samples/input.json",
            "output_payload_path": "samples/output.json",
        },
    ...
    print(
        f"Updated Stage 9 JSON baseline: {BASELINE_PATH} | "
